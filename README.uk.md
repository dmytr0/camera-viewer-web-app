...
> **Дисклеймер:** Цей проєкт створено за допомогою AI і надається як є, без будь-яких гарантій. Автор не несе відповідальності за будь-які збитки, втрату даних або інші наслідки від використання програми. Використовуйте на власний страх і ризик.
...
Створено та протестовано з IP-камерою модуля **5MP з 30× оптичним зумом** (на базі HiXVision/HiSilicon).

[![5MP 30x zoom камера](media/img.png)](https://s.click.aliexpress.com/e/_c4MdieUV)

🛒 [Купити на AliExpress](https://s.click.aliexpress.com/e/_c4MdieUV)

**Документація на камеру:**
- [Інструкція](docs/camera-manual.html)
- [Datasheet (PDF)](docs/zoom_cam.pdf)
...
- **Перемикання мови** — Ukrainian / English, запам'ятовується у браузері
